const DATA = {
  ...
  "Stacks": {
    "Stacks": {
      ...
      "theory": {
        generalKnowledge: "A stack is a linear data structure that follows the LIFO principle — Last In, First Out. This means the last element inserted is the first one to be removed, just like a stack of plates — you always add and remove from the top.",
        declaration:
        {
          theory: "You specify data type and size of array",
          codeSnippet: "./public/code-snippets/array/1-D-declaration.png"
